/**
 * Clients page (root path) - Refactored with StandardPageLayout
 */
    ...
    <DashboardLayout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <ol className="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
              <div className="flex items-center">
                ...
                <span className="text-sm font-medium text-gray-500">{t('clients.title')}</span>
              </div>
            </li>
          </ol>
        </nav>
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-sm text-gray-600">{t('clients.description')}</p>
        </div>
