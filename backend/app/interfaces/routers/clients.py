...
clients_request_duration_seconds = Histogram("clients_request_duration_seconds", "Request duration for clients endpoints")
...
@router.post("", response_model=ClientResponse, status_code=status.HTTP_201_CREATED, dependencies=[Depends(require_clients_write)])
...
@router.get("/{client_id}", response_model=ClientResponse, dependencies=[Depends(require_clients_read)])
@clients_request_duration_seconds.time()
...
@router.patch("/{client_id}", response_model=ClientResponse, dependencies=[Depends(require_clients_write)])
@clients_request_duration_seconds.time()
...
@router.delete("/{client_id}", status_code=status.HTTP_204_NO_CONTENT, dependencies=[Depends(require_clients_write)])
@clients_request_duration_seconds.time()
...
@router.get("/{client_id}/history", response_model=ClientHistoryResponse, dependencies=[Depends(require_clients_read)])
@clients_request_duration_seconds.time()
