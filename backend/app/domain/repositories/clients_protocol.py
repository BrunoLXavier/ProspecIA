...
from typing import Any, Dict, Optional, Sequence, Protocol, runtime_checkable
...
class ClientsRepositoryProtocol(Protocol):
    ...
    async def get(self, client_id: UUID, tenant_id: UUID, include_excluded: bool = False) -> Optional[Client]: ...
